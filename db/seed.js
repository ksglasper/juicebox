...
const createInitialPosts = async () =>{
    ...
    console.log("Starting to create user posts...");
        ...
        await createPost({
            authorId: sandra.id,
            title: "Sandra Here!",
            content: "This is my first post. I hope I love writing blogs as much as I love writing them. This is Sandra BTW."
          });

          await createPost({
            authorId: glamgal.id,
            title: "First Post, jk tenth post",
            content: "This is my 80th post. I hope I love writing blogs as much as I love writing them."
          });
